...
public class UsuarioController {
    ...
    public boolean atualizarUsuario(int id, String nome, String cpf, String email, String cargo, String login, String senha, String perfil){
        try{
    ...
    private boolean validarDadosUsuario(String nome, String cpf, String email, String login, String senha){
